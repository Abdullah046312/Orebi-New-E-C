        ...
        <Container>
          ...
          <Flex>
            <div className="flex gap-8 pt-10">
              <div className="w-[48%]">
                <img className='w-full' src={images18} alt="" />

              </div>
              <div className="w-[48%]">
                <img className='w-full' src={images19} alt="" />
          ...
          <Flex>
            <div className="flex gap-8 pt-10">
              <div className="w-[48%]">
                <img className='w-full' src={images20} alt="" />

              </div>
              <div className="w-[48%]">
                <img className='w-full' src={images21} alt="" />
          ...
          <div className="flex gap-3 items-center">
            <FaStar className='text-[#FFD881] text-[20px]' />
            <FaStar className='text-[#FFD881] text-[20px]' />
            <FaStarHalfAlt className='text-[#FFD881] text-[20px]' />
            <FaRegStar className='text-[#FFD881] text-[20px]' />
            <div className="">
          ...
          <div className="flex gap-3 mt-3 items-center">
            <h3 className='text-[16px] font-DMs font-normal text-[#767676] line-through '>$88.00</h3>
          ...
          <div className="">
          <div>
                                <label className='pr-6 text-[18px] font-DMs font-bold text-[#262626]' htmlFor="">STATUS:</label>
                                <select className="w-[120px] h-[30px] border-[1px] border-[rgba(118,118,118,0.49)] text-[16px] text-[#767676] font-DMs font-normal mt-5">
                                    {['In Stock', 'out Of Stock', 'Coming-Soon',].map((option, index) => (
                                        <option key={index} value={option.toLowerCase()}>{option}</option>
                                    ))}
                                </select>
                            </div>
    ...
    {show && (
        <ul className="mt-3">
          ...
          <div className="flex mt-5">
            ...
            <FaStar className='text-[#FFD881] text-[20px] pr-5' />
            <FaStar className='text-[#FFD881] text-[20px]' />
            <FaStar className='text-[#FFD881] text-[20px]' />
            <FaStar className='text-[#FFD881] text-[20px]' />
            <FaStar className='text-[#FFD881] text-[20px]' />
